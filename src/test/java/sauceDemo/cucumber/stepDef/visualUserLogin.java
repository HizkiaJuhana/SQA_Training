...
public class visualUserLogin {
    WebDriver driver;
    String baseurl = "https://www.saucedemo.com/";
    @Given("user berada di saucedemo.com")
    public void userBeradaDiSaucedemocomAsVisualUser() {
    ...
    @When("input username")
    public void inputUsernameAsVisualUser() {
        // Write code here that turns the phrase above into concrete actions
        driver.findElement(By.id("user-name")).sendKeys("visual_user");
    }

    @And("input password")
    public void inputPasswordAsVisualUser() {
        // Write code here that turns the phrase above into concrete actions
        driver.findElement(By.id("password")).sendKeys("secret_sauce");
    }

    @And("klik pada tombol login")
    public void klikPadaTombolLoginAsVisualUser() {
        // Write code here that turns the phrase above into concrete actions
        driver.findElement(By.id("login-button")).click();
    }

    @Then("user akan diarahkan ke Home Page")
    public void userAkanDiarahkanKeHomepageAsVisualUser() {
        // Write code here that turns the phrase above into concrete actions
